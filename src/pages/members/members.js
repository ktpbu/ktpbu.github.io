...
/* TODO:
 *  make collapsible by class
 *    maybe use this: https://www.geeksforgeeks.org/how-to-use-collapse-component-in-reactjs/#
      ...
      <div className="members_section">
          ...
          <a href="https://www.linkedin.com/in/paul-lee-55119725a/">
            <div className="member_card">
              ...
              <h2>
                Paul Lee
                <br />
                <span style={{ color: "#7ac6d6" }}>Co-President</span>
              </h2>
            </div>
          </a>
          ...
          <a href="https://www.linkedin.com/in/jaden-hsiao-b72a7b24b/">
            <div className="member_card">
              ...
              <h2>
                ...
                <br />
                <span style={{ color: "#7ac6d6" }}>
                  Co-Vice President of Engagement
                </span>
              </h2>
            </div>
          </a>
        ...
        <div className="small-members-cards-container">
          ...
          <a href="https://www.linkedin.com/in/ishanbhattacharjee/">
            <div className="small_member_card">
              <img
                src={IshanBhattacharjee}
                alt="Ishan Bhattacharjee Headshot"
                loading="lazy"
              />
          ...
          <a href="https://www.linkedin.com/in/eric-nohara-leclair-189298291/">
            <div className="small_member_card">
              <img
                src={EricNoharaLeClair}
                alt="Eric Nohara-LeClair Headshot"
                loading="lazy"
              />
        ...
        <div className="small-members-cards-container">
          ...
          <a href="https://www.linkedin.com/in/mferiancek/">
            <div className="small_member_card">
              <img
                src={MatthewFerianeck}
                alt="Matthew Ferianeck Headshot"
                loading="lazy"
              />
        ...
        <h1>
          <span style={{ color: "#a3e4a3" }}>"</span> Founding Members
        </h1>
